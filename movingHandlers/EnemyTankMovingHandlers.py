...
class EnemyTankMovingHandlers(actions.Move):
    ...
    def __init__(self):
        super(EnemyTankMovingHandlers, self).__init__()
        #self.Bot = DefaultBot()
    ...
    def step(self, dt):
        ...
        super(EnemyTankMovingHandlers, self).step(dt) # Run step function on the parent class.
